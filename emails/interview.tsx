...
export const SimpleInterviewEmail = () => {
  return (
    <Html>
      <Head />
      <Preview>
        ThinkTank Interview Information - Please check Discord for details
      </Preview>
      <Body style={main}>
        <Container style={container}>
          <Section
          ...
          <Text style={paragraph}>Howdy!</Text>
          <Text style={paragraph}>
            TAMU ThinkTank would like to interview you for a position. Your
            interview has been scheduled, and all details are available in our
            Discord server.
          </Text>
          <Text style={paragraph}>
            <strong>IMPORTANT:</strong> Please join our Discord server
            immediately to receive information about your interview time,
          ...
          <Text style={paragraph}>
            If you have any questions or issues with links, please contact us at
...
export default SimpleInterviewEmail;
