            ...
            <div className="mb-4 flex w-full items-center justify-start lg:mb-0">
              <div className="lg:-ml-25 relative flex items-center">
                <div className="relative">
                  <div className="absolute -left-10 -top-16  origin-bottom-right -rotate-90 transform text-2xl font-bold text-[#949494] lg:-left-20 lg:-top-20 lg:ml-5 lg:text-3xl xl:ml-5">
                    TAMU
                  </div>
                </div>
                <h2 className="font-poppins ml-7 text-[5rem] font-bold text-[#949494] lg:ml-7 lg:text-8xl xl:ml-7">
                  ThinkTank
                </h2>
              </div>
              <button
