...
const OfficerInterest = () => {
  return (
    <div className="flex flex-col items-center justify-center p-10 bg-gray-900 text-white">
      <h2 className="text-3xl font-semibold mb-4 italic md:text-4xl">Officer Application</h2>
      ...
      <a href="#" className="px-4 py-2 border border-white text-white rounded-full hover:bg-white hover:text-black transition duration-300 ease-in-out">
        Apply Now ›
      </a>
    </div>
  );
