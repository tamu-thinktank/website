...
const faqData = [
  {
    ...
    answer: (
      <>
        <p className="mb-4">
          MATE ROV teams are meant for ThinkTank's Design Challenge Alumni, but
          students with relevant qualifications and prior experience are
          encouraged to apply.
        </p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        <p className="mb-4">
          All MATE ROV members are expected to contribute{" "}
          <strong>at least 12 hours per week</strong> (equivalent to 3 classes).
        </p>
        <p className="mb-4">The schedule includes:</p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
            Weekly team work meetings every Sunday from{" "}
            <strong>10 am - 12 pm</strong>
          </li>
          <li>
            Biweekly progress reports every Saturday from{" "}
  ...
  },
  {
    ...
    answer: (
      <>
        <p className="mb-4">
          The team will be split into the following subteams with 2-3 members in
          each:
        </p>
        ...
        <p className="mt-4">
          Leading the team will be a Project Manager and a Chief Systems
          Engineer who will be responsible for ensuring the members and
          technical aspects respectively all function well.
        </p>
      </>
    ),
  },
