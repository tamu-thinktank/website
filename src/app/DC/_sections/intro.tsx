    ...
    <TabsContent className="space-y-2" value="start">
      <Card>
        ...
        <CardContent className="text-center">
          ...
          There are 2 multiple-choice sections and 1 open-end question section with a resume upload at the end. We recommend writing your free responses in a separate document and transferring them to the application. Additionally, we recommend having your resume downloaded on your device before continuing.{" "}
          <br /> <br />
          Please note: Applications with missing or incomplete responses will be automatically rejected. We encourage you to take your time and thoroughly fill out the application. ThinkTank reserves the right to vary evaluation criteria each recruitment cycle based on number of applications, available officer positions, and other relevant factors.
          <br /> <br />
          <strong>
