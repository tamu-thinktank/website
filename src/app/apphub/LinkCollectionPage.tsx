...
const linksData = [
  {
    ...
    url: "/officer-apply",
    description: "Officer application is currently closed.",
    status: "closed",
  },
  {
    type: "MateROV",
    ...
    url: "/materov-apply",
    description: "MateROV application is currently closed.",
    status: "closed",
  },
  {
    ...
    url: "#",
    description: "General applications are now open.",
    status: "open",
  },
  {
    type: "MiniDC",
    ...
    url: "/minidc-apply",
    description: "MiniDC application coming soon.",
    status: "soon",
  },
];
...
const LinkCollectionPage: React.FC = () => {
  const [selectedDescription, setSelectedDescription] = useState<string>(
    "Hover over a link to see its description.",
  );
      ...
      <div className="mt-16 grid gap-6 md:grid-cols-2">
        {linksData.map((link, index) => (
          <a
            ...
            className={`block transform rounded-2xl p-6 text-white shadow-md transition-transform hover:scale-105 ${link.status === "closed" ? "cursor-not-allowed bg-gray-400" : link.status === "soon" ? "bg-yellow-500" : link.type === "Officer" ? "bg-blue-500" : "bg-green-500"}`}
          >
