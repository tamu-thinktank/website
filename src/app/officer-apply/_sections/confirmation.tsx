    ...
    <div className="flex h-full w-screen items-center justify-center">
      <Card className="my-4 w-11/12 md:w-3/4 lg:w-1/2">
        ...
        <CardContent className="space-y-6 text-center">
          <p>
            Thank you for applying to become a ThinkTank Officer! You will receive an email with your responses momentarily.
          </p>
          ...
          <p>
            If you want to prepare further for your potential interview, we recommend reading further into our core values in addition to determining potential improvements to ThinkTank’s operations.
          </p>
