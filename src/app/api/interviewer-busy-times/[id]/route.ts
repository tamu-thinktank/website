...
export async function PATCH(
  ...
  try {
    ...
    console.log(`Updated busy time for ${existingBusyTime.interviewer.name}: ${finalStartTime.toLocaleString()} - ${finalEndTime.toLocaleString()}`)
...
export async function DELETE(
  ...
  try {
    ...
    console.log(`Deleted busy time for ${existingBusyTime.interviewer.name}: ${existingBusyTime.startTime.toLocaleString()} - ${existingBusyTime.endTime.toLocaleString()}`)
