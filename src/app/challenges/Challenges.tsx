...
import BoxComponent from "./box_components"; // Assuming you have the BoxComponent in the same directory
  ...
  const teams = [
    {
      ...
      imageUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSK7R7OIUg1uWdF5NKWZgGWSg3AJZ1_Har5kw&s", // Add a valid image URL for Daedalus
    },
    {
      teamName: "Altas",
      ...
      imageUrl:
        "https://thewebcycle.com/wp-content/uploads/2022/07/PMG-WITH-WHITE-TEXT-Copy-e1657541928389.png", // Add a valid image URL for Altas
    },
    {
      teamName: "Nova",
      shortOverview: "Design NASA’s Next Lunar Base",
      competitionOverview:
        "RASC-AL is looking for a research proposal for the design, development, and operation of a Lunar Base on the South Pole of the moon.",
      duration: "2 Semesters",
      teamSize: "12-20",
      admissionTimeline:
        "Applications Due: 9/6/24\nInterviews End: 9/15/24\nAcceptance: 9/16/24",
      researchAreas: [
