...
import { qMiniDC, PRONOUN_OPTIONS, GENDER_OPTIONS } from "@/consts/apply-form";
...
export default function PersonalInfo() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <Card>
        <CardHeader>
          <CardTitle className="text-center">{qMiniDC.personal.title}</CardTitle>
          <Separator />
        </CardHeader>
      </Card>
        ...
        render={({ field }) => (
          <FormItem>
            <Card>
              <CardHeader>
                <CardTitle>
                  {qMiniDC.personal.fullName} <span className="text-red-500">*</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <FormControl>
        ...
        render={({ field }) => (
          <FormItem>
            <Card>
              <CardHeader>
                <CardTitle>
                  {qMiniDC.personal.preferredName}{" "}
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <Card>
              <CardHeader>
                <CardTitle>{qMiniDC.personal.pronouns}</CardTitle>
              </CardHeader>
              <CardContent>
                <RadioGroup
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <Card>
              <CardHeader>
                <CardTitle>{qMiniDC.personal.gender}</CardTitle>
              </CardHeader>
              <CardContent>
                <RadioGroup
                  value={field.value?.startsWith("OTHER:") ? "OTHER" : field.value ?? ""}
        ...
        render={({ field }) => (
          <FormItem>
            <Card>
              <CardHeader>
                <CardTitle>
                  {qMiniDC.personal.uin} <span className="text-red-500">*</span>
                </CardTitle>
                <CardDescription>
        ...
        render={({ field }) => (
          <FormItem>
            <Card>
              <CardHeader>
                <CardTitle>
                  {qMiniDC.personal.email} <span className="text-red-500">*</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <FormControl>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <Card>
              <CardHeader>
                <CardTitle>{qMiniDC.personal.altEmail}</CardTitle>
                <CardDescription>
        ...
        render={({ field }) => (
          <FormItem>
            <Card>
              <CardHeader>
                <CardTitle>
                  {qMiniDC.personal.phone} <span className="text-red-500">*</span>
                </CardTitle>
                <CardDescription>
