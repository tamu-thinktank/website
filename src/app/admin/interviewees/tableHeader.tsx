...
import type { TableHeaderProps } from "./intervieweetypes";

export const TableHeader: React.FC<TableHeaderProps> = ({ headers }) => {
  return (
    <div className="bg-opacity-10 flex w-full flex-col overflow-hidden rounded-[47px_47px_0px_0px] bg-white px-px pt-3 text-neutral-200 max-md:max-w-full">
