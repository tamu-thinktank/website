...
export default function FormIntro() {
  return (
    <Card>
      ...
      <CardContent>
        Our club's mission is to provide
        ...
        your resume downloaded on your current device before proceeding. <br /> <br />
        ...
        thoroughly fill out the application. TAMU ThinkTank (TTT) reserves the right to vary the
        evaluation criteria from semester to semester based on the number of
        applicants, available teams, competition requirements, and other relevant factors.<br /> <br />
