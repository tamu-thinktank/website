    ...
    <TabsContent className="space-y-2" value="start">
      <Card>
        ...
        <CardContent className="text-center">
          ...
          <br /> <br />
          The MATE ROV challenge is a hands-on engineering competition where
          students design, build, and operate underwater ROVs (remotely operated
          vehicles) to complete tasks. These tasks simulate real-world
          challenges faced by professionals in industries like ocean
          exploration, marine science, and the management of offshore energy.
          Students applying to the team are expected to bring commitment,
          creativity, and a collaborative spirit. To learn more, please visit
          the MATE ROV Competition Website
          <br /> <br />
          There are 2 multiple-choice sections and 1 open-ended question section
          ...
          on your device before continuing.
          <br /> <br />
          ...
          applications, available team positions, and other relevant factors.
          <br />
          <br />
          <strong>
            WE HIGHLY RECOMMEND READING THE RECURRING TEAM FAQ AND COMPLETING
            THE APPLICATION ON A LAPTOP/DESKTOP
          </strong>
        </CardContent>
      </Card>
